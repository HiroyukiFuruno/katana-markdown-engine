...
- KME owns renderer-neutral document model DTOs. Do not expose third-party parser AST types as public contract.
- KME must not depend on KatanA, kcf, kdp, kle, or UI frameworks.
