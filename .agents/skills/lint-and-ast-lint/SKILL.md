...
description: katana-markdown-engine の通常lint、KAL AST lint、test、OpenSpec検証を実行する。
---
...
- `scripts/openspec validate "bootstrap-kme-document-model" --strict`

## ルール

- 失敗した検査をskipしない。
- AST lintは `katana-ast-lint` を使う。
- KME固有の一時lintや除外設定で代替しない。
